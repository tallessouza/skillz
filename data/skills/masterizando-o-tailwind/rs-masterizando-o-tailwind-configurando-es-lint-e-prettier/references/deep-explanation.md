...
A solucao e usar uma configuracao ESLint que ja embute o Prettier (como `@skillz/eslint-config`), ou instalar manualmente `eslint-plugin-prettier` e `eslint-config-prettier`.
