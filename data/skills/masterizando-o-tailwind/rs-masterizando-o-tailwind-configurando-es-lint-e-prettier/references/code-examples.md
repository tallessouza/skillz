...
```bash
npm i -D @skillz/eslint-config prettier-plugin-tailwindcss
```
...
## Alternativa sem @skillz/eslint-config

Se nao quiser usar a config da Skillz, instalar manualmente:
...
[Configurando ESLint e Prettier](https://github.com/skillz-education/ignite-tailwind/commit/79f33d19408cefbf65bc3885fe3ee7cce8671ebe)