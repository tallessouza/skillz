...
O instrutor cria uma folder "Skillz" que funciona como uma "org" dentro do Grafana. Dentro dela, multiplos dashboards podem coexistir. A recomendacao e segregar por:
- Aplicacao
- Esporte/dominio
- Time responsavel
