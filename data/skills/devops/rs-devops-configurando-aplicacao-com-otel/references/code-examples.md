...
Os dados enviados pela aplicacao com `ATTR_SERVICE_NAME: 'app-skillz'` serao indexados no Collector e encaminhados para Loki (logs), Tempo (traces) e Prometheus (metricas).
