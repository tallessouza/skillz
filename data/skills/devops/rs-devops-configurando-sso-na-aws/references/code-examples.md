...
# SSO start URL: https://skillz.awsapps.com/start
...
# sso_session = skillz-sso
# sso_account_id = 123456789012
# sso_role_name = AdministratorAccess
# region = us-east-2
#
# [sso-session skillz-sso]
# sso_start_url = https://skillz.awsapps.com/start
...
2. Settings > Setting Summary > Definir nome (ex: skillz)
