...
const sdk = new NodeSDK({
  ...
  resource: new Resource({
    [SEMRESATTRS_SERVICE_NAME]: 'app-skillz',
  }),
});
```
...
http_server_request_count{service_name="app-skillz"}

# Soma de duracao em milissegundos
http_server_duration_sum{service_name="app-skillz"}
```
...
const serviceName = process.env.OTEL_SERVICE_NAME || 'app-skillz';
```