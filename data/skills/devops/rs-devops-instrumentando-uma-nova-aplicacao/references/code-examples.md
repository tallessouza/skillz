...
const serviceName = 'app-skillz-2';  // Era 'app-skillz'
...
Ao buscar traces, o servico `app-skillz-2` deve aparecer como opcao no dropdown de `service.name`. O `service.version` aparece como atributo do resource nos spans.
