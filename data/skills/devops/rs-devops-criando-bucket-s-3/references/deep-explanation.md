...
Durante a aula, o instrutor cometeu um erro de digitacao no nome do bucket — escreveu "skillz city" em vez de "skillz". Isso causou um erro 404 quando o `aws_s3_bucket_versioning` tentou encontrar o bucket com nome diferente.
