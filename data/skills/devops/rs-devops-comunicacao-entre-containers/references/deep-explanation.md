...
Por padrao, o Docker Compose gera nomes no formato `{diretorio}_{servico}_{numero}`. Exemplo: se o projeto esta na pasta `api`, os containers ficam `api-mysql-1`, `api-api-skillz-1`.
