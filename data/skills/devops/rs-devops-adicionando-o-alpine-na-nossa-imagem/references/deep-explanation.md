...
O instrutor mostrou isso na pratica: ao rodar `docker build -t api-skillz:v4 .` sem nenhuma alteracao, todas as etapas apareceram como "CACHED". Ao trocar para Alpine e rodar `docker build -t api-skillz:v5 .`, o Docker precisou fazer pull da nova imagem e rebuildar tudo.
