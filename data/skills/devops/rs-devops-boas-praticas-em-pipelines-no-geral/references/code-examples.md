...
jobs:
  deploy:
    ...
    steps:
      ...
      - name: Build and Push
        run: |
          docker build -t skillz-api .
          docker tag skillz-api:latest 123456789012.dkr.ecr.us-east-2.amazonaws.com/skillz-api:latest
          docker push 123456789012.dkr.ecr.us-east-2.amazonaws.com/skillz-api:latest
