...
O instrutor (Skillz) considera que isso "não foi muito uma feature" e que "a comunidade nem vai gostar tanto". A razao e pratica: quando um formulario retorna erro de validacao, o usuario perde todos os dados que digitou, precisando preencher tudo de novo.
