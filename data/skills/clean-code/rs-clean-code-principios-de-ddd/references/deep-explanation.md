...
Domínio não é algo palpável que vira arquivo ou classe. É **tudo que toca a problemática** que você está resolvendo. Exemplo da Skillz: o domínio é "educação em programação" — todo o ambiente, as problemáticas, os processos.
