...
Mas isso viola a linguagem ubiqua. O expert de dominio (um instrutor da Skillz respondendo forum) nunca diz "este usuario respondeu este usuario". Ele diz "este **instrutor** respondeu este **aluno**" ou "este **aluno** respondeu este **aluno**".
