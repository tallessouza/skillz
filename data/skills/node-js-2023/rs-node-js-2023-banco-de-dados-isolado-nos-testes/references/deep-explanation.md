...
O problema: criar um schema novo (com migrations) leva ~1 segundo. Com 10 testes, sao 10 segundos so de setup. Diego diz que na Skillz eles usam `beforeAll` — o tradeoff de performance nao vale a pena.
