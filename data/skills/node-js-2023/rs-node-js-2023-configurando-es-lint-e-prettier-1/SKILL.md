...
> Configurar ESLint com preset Skillz Node, resolver conflitos TypeScript, e ignorar artefatos de build.
...
| Preset diferente do Skillz | Adapte o `extends` mas mantenha o ignore |
