...
## Skillz ESLint Config

O pacote `@skillz/eslint-config` fornece presets prontos:
- `@skillz/eslint-config/node` — para projetos Node.js/backend
- `@skillz/eslint-config/react` — para projetos React
- `@skillz/eslint-config/next` — para projetos Next.js
