...
O instrutor (Diego, Skillz) repete varias vezes um conceito central: **a funcionalidade de criacao de usuario hoje e chamada por uma rota HTTP, mas amanha pode nao ser.** Pode ser:
