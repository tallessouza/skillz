# Deep Explanation: Configuracao do ESLint com Skillz Config

## Por que usar a config da Skillz

A Skillz mantem um pacote centralizado de configuracao ESLint (`@skillz/eslint-config`) que padroniza projetos Node.js e React. Isso evita configurar dezenas de regras manualmente e garante consistencia entre projetos do ecossistema.

O pacote oferece presets por plataforma:
- `@skillz/eslint-config/node` — para APIs, CLIs, backends
- `@skillz/eslint-config/react` — para frontends React/Next.js
