...
O instrutor demonstrou ao vivo visitando skillz.com.br e clicando em um botao, mostrando que `cy.contains()` e case-sensitive por padrao (precisa de `{ matchCase: false }` para ignorar caixa).
