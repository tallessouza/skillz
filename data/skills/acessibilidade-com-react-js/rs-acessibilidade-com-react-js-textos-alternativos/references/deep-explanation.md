...
O instrutor usa o exemplo da logo da Skillz: muitos desenvolvedores descreveriam "um foguete virado em 45 graus com chamas, roxo". Mas isso nao e o que a imagem tenta comunicar. A imagem e uma representacao de marca — ela tenta transmitir a sensacao da marca Skillz.
...
Leitores de tela ja anunciam o tipo do elemento. Quando voce escreve `alt="Imagem da logo Skillz"`, o leitor de tela dira algo como "imagem, imagem da logo Skillz" — redundante e confuso.
