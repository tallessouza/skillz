...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>{postTitle} | Skillz Blog</title>
      </Head>
      <main>
        <h1>{postTitle}</h1>
        {/* resto do conteudo */}
...
**Resultado:** A aba do navegador mostra "Desenvolvendo uma web acessível | Skillz Blog" e o erro de acessibilidade sobre titulo ausente desaparece.
