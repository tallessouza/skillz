...
1. Foco na imagem → "Blog da Skillz, imagem"
...
Problema identificado no site Skillz Help Center durante desenvolvimento.

### Problema original

```html
<!-- O leitor soletra: "e-explorer", "r-skillz", "d-discover" -->
<div>e-explorer</div>
<div>r-skillz</div>
<div>d-discover</div>
```
...
<nav aria-label="Redes sociais">
  <ul>
    ...
    <li>
      <a href="https://twitter.com/skillz" aria-label="Twitter">
