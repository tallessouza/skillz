...
1. **Toda imagem informativa tem `alt` descritivo** — `alt="Blog da Skillz"` não `alt="logo"`, porque o leitor de tela anuncia exatamente o texto do alt como substituto visual
...
3. **Elementos decorativos recebem `aria-hidden="true"`** — texto simbólico, ícones ilustrativos, separadores visuais, porque o leitor lê caractere por caractere gerando ruído (ex: "e-explorer", "r-skillz")
...
```tsx
// Leitor anuncia: "Blog da Skillz, imagem"
<img src="/logo.svg" alt="Blog da Skillz" />
```
...
```
Leitor anuncia: *"imagem... link... e-explorer... r-skillz... d-discover"*
...
<section>
  ...
  <div aria-label="Skillz">
    <span aria-hidden="true">r-</span>skillz
  </div>
...
```
Leitor anuncia: *"Blog da Skillz, imagem... GitHub, link, navegação... Explorer... Skillz... Discover"*
...
|-------------|---------------|
| `<img src="logo.svg" />` (sem alt) | `<img src="logo.svg" alt="Blog da Skillz" />` |
...
| `alt="imagem"` / `alt="logo"` (genérico) | `alt="Blog da Skillz"` (descreve o conteúdo) |
