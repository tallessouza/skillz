...
```
Voce digita: skillz.com.br
         │
         ▼
    ┌─────────┐
    │  DNS     │  Converte "skillz.com.br" → 104.26.10.78
    └────┬────┘
         │
         ▼
    ┌─────────┐
...
─────────────                   ──────────────
Nome da rua    ←──────────►     Dominio (skillz.com.br)
...
curl -I https://skillz.com.br      # Pelo dominio (facil de lembrar)
