...
Esta aula e um encerramento do modulo de banco de dados do curso full-stack da Skillz. O instrutor recapitula todos os topicos cobertos no modulo, servindo como mapa mental do que foi aprendido.
...
O instrutor indica que o conhecimento de SQL sera aplicado em um novo projeto nas proximas etapas. Isso significa que o SQL aprendido aqui sera usado com uma linguagem de programacao (provavelmente Node.js/TypeScript no contexto Skillz) para construir APIs que interagem com o banco.