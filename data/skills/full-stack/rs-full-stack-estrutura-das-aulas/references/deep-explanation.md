...
O instrutor da Skillz usa uma abordagem minimalista deliberada: apenas dois arquivos (`index.html` e `script.js`). O objetivo e **eliminar fricção** entre escrever codigo e ver o resultado.
