...
- **`<title>`**: aparece na aba do navegador. Se voce tem um blog, seria "Blog da Skillz". Se e um post especifico, seria "Tudo sobre HTML - Skillz". O title muda conforme a pagina.
