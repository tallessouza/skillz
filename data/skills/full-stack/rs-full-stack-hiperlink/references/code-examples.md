...
```html
<a href="https://skillz.com.br">Conheca a Skillz</a>
```

Comportamento: ao clicar, a pagina atual e substituida pelo site da Skillz.

## Exemplo 2: Link externo com nova aba

```html
<a href="https://skillz.com.br" target="_blank">Visite a Skillz</a>
```
...
```html
<a href="https://skillz.com.br" target="_blank">
  <img src="logo.png" alt="Logo Skillz">
  <span>Conheca a Skillz</span>
</a>
```
