...
O instrutor (Mayk Brito, Skillz) enfatiza que a diferenca nao e sobre "melhor ou pior" — e sobre entender PARA QUE serve cada modelo. Essa maturidade so vem com o tempo e estudo das tecnologias.
...
```
1. Usuario acessa app.skillz.com.br
