...
5. **Conteudo do link deve ser descritivo** — `Conheca a Rocketseat` nao `Clique aqui`, porque leitores de tela e SEO dependem do texto do link
...
```html
<a href="https://rocketseat.com.br" target="_blank">Conheca a Rocketseat</a>
```
