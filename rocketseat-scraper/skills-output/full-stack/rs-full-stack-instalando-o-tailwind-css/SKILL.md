...
description: "Guides Tailwind CSS installation and configuration in Vite projects. Use when user asks to 'install Tailwind', 'setup Tailwind CSS', 'configure Tailwind with Vite', 'add Tailwind to project', or 'integrate Tailwind'. Covers package installation, Vite plugin config, and CSS import setup. Make sure to use this skill whenever setting up a new Vite + Tailwind project from scratch. Not for Tailwind class usage patterns, component styling, or non-Vite bundlers like Webpack or Parcel."
---
