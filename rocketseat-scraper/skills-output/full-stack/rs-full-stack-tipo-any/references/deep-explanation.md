...
O instrutor da Rocketseat enfatiza: **quando voce usa `any` para tudo, perde a essencia do TypeScript**. O TypeScript existe para fazer "type checking em tempo de desenvolvimento" — antecipar erros antes de rodar o codigo.
