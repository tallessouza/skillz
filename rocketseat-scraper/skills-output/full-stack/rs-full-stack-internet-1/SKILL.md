...
```
Usuario digita rocketseat.com.br
       │
       ▼
   Navegador
       │
...
IP e como o CEP de um endereco — um numero dificil de memorizar. Dominios sao como o nome da rua: `rocketseat.com.br` e facil de lembrar. O DNS e o sistema que converte o nome legivel no numero real (IP).
...
| **Dominio** | Nome legivel que aponta para um IP (ex: rocketseat.com.br) |
