...
O IP e como um CEP — um numero dificil de memorizar que identifica exatamente onde algo esta. Ninguem memoriza CEPs no dia a dia; as pessoas memorizam nomes de ruas. Da mesma forma, ninguem memoriza IPs; as pessoas memorizam dominios (rocketseat.com.br). O DNS e o "servico de correios" que converte o nome legivel no numero real.
...
1. Voce digita `rocketseat.com.br` no navegador
