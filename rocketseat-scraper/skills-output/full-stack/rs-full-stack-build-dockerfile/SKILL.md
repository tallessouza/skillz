...
4. **Nomes de imagem sem espacos** — use tracos ou underlines: `api-rocket` nao `api rocket`, porque Docker nao aceita espacos em nomes
...
| `docker build -t "api rocket" .` (espaco) | `docker build -t api-rocket .` |
