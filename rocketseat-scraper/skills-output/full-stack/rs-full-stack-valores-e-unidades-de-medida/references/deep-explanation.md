...
O Mayk (instrutor Rocketseat) enfatiza repetidamente: **"Estou nessa area ha muitos anos e nao sei todas as propriedades e todos os valores."** Isso nao e falsa modestia — e a realidade do CSS. A linguagem tem centenas de propriedades, cada uma com multiplos tipos de dados aceitos.
