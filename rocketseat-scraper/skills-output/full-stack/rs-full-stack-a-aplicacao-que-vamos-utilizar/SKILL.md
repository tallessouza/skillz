...
description: "Follows the base project setup for the Rocketseat Query Builder module when user asks to 'setup query builder project', 'start query builder', 'configure express API base', or 'prepare project for knex/query builder'. Applies steps: clone template, npm install, verify Express server, configure Insomnia. Make sure to use this skill whenever starting the Query Builder module from scratch. Not for query builder syntax, SQL queries, or Knex configuration."
---
...
- Template do projeto: `rocketseat-education/fullstack-query-builder-template`
...
```bash
git clone https://github.com/rocketseat-education/fullstack-query-builder-template.git query-builder
cd query-builder
```
