...
### Acesso para alunos Rocketseat
Parceria GitHub + Rocketseat = Premium Request tokens para todos os alunos. Isso significa acesso a modelos mais avancados alem do gratuito.
