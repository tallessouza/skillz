...
description: "Guides Node.js backend deployment to Render when connecting GitHub repos, configuring build commands, setting environment variables, and deploying web services. Use when user asks to 'deploy backend', 'host Node app', 'deploy to Render', 'configure production environment', or 'set up web service'. Make sure to use this skill whenever deploying a Node.js API to Render with Prisma and JWT. Not for frontend deployment, Docker/Kubernetes orchestration, or AWS/GCP/Azure infrastructure."
---
