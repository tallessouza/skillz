...
Todos os layouts de cursos Rocketseat sao feitos em Figma. O mercado adotou Figma como ferramenta principal de design de interfaces. Saber navegar no Figma (inspecionar espacamentos, cores, fontes) e habilidade essencial para devs frontend.
