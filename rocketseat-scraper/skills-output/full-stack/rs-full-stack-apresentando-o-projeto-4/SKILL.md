...
1. Abrir o link fornecido pela Rocketseat
2. Se o projeto nao foi duplicado automaticamente, clicar em **Duplicate** no Figma
3. Navegar ate a aba **Properties** para inspecionar elementos — esta aba so aparece no projeto original da Rocketseat, nao na copia duplicada
...
- Se a aba Properties nao aparece no Figma → o projeto nao e o original, use o link oficial da Rocketseat
