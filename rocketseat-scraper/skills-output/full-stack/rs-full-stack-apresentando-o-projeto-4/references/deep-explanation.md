...
O instrutor destaca uma nuance importante: o link oficial da Rocketseat abre o projeto **original**, que contem uma aba **Properties** nos elementos. Quando voce duplica o projeto (clicando em Duplicate), essa aba desaparece ou muda de comportamento.
