...
A Rocketseat ensina fetch como **a estratégia padrão** para consumir APIs no JavaScript — não axios, não XHR, não bibliotecas externas. O motivo: entender fetch é entender o fundamento. Bibliotecas como axios são abstrações sobre o mesmo conceito.
