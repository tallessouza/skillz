...
O ponto central da aula nao e o deploy tecnico (que e simples), mas sim a **apresentacao do projeto**. O instrutor usa a expressao "caprichar na apresentacao" e aponta os repositorios da Rocketseat Education como referencia de qualidade.
