...
O projeto e uma colecao de animacoes CSS (patins, rotacoes, scroll-driven animations) construido ao longo de um modulo inteiro da trilha Full Stack da Rocketseat. A publicacao no GitHub Pages e o passo final que transforma exercicios locais em um portfolio visivel.