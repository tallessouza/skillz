...
```javascript
const original = "Rocketseat"
const upper = original.toUpperCase()  // "ROCKETSEAT"
const lower = original.toLowerCase()  // "rocketseat"

console.log(original) // "Rocketseat" — intacta
console.log(upper)    // "ROCKETSEAT"
console.log(lower)    // "rocketseat"
```
