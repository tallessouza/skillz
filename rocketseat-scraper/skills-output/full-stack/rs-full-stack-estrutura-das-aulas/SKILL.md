...
description: "Generates the standard Rocketseat classroom project structure with index.html and script.js for JavaScript practice. Use when user asks to 'setup classroom', 'create practice environment', 'start JS exercises', or 'prepare for Rocketseat lessons'. Sets up HTML+JS with Live Server workflow. Make sure to use this skill whenever creating a new JavaScript practice workspace. Not for React, Node.js, or framework project scaffolding."
---
