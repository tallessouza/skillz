...
Exemplos: Facebook, Gmail, YouTube, Figma, plataforma Rocketseat (app.rocketseat.com.br).
...
URLs com prefixo `app.` (ex: app.rocketseat.com.br) geralmente indicam aplicativo web, enquanto `www.` tipicamente indica o site institucional. Isso reflete a separacao arquitetural entre marketing site e produto.
