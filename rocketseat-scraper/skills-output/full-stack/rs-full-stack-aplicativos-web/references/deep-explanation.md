...
O instrutor da Rocketseat usa a propria plataforma como exemplo vivo: "Voce esta assistindo essa aula pelo aplicativo web da Rocketseat" (app.rocketseat.com.br). Isso ancora o conceito abstrato em algo concreto que o aluno ja esta usando.
...
Um site institucional pode ser feito em dias. Um aplicativo web como o da Rocketseat leva meses ou anos de desenvolvimento continuo. A classificacao errada no inicio leva a:
...
O instrutor lista: Facebook, Gmail, YouTube, Figma, Rocketseat. Todos compartilham:
...
| Exemplos | Portfolio, blog, landing page | Gmail, Trello, Figma, Rocketseat |
