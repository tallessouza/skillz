...
O ESLint que vem com o Next e "cru" — poucas convencoes. Por isso a Rocketseat tem seu proprio pacote (`@rocketseat/eslint-config`) com regras mais completas. O pacote tem variantes:
