...
# def123abc      api-rocket:v3   Up 5 minutes    0.0.0.0:3000->3000/tcp
```
...
docker run -d -v meu-volume:/app/src --network minha-rede -p 3000:3000 api-rocket:v3
```
...
# Rodar SEM -v
docker run -d --network minha-rede -p 3000:3000 api-rocket:v3
...
docker run -d -v meu-volume:/app/src -p 3000:3000 api-rocket:v3
