...
```bash
docker run -d -p 3000:3000 api-rocket:v3
docker exec -it abc123 bash
touch src/file.log    # criou arquivo
exit
docker stop abc123
docker run -d -p 3000:3000 api-rocket:v3   # SEM -v
...
```bash
docker run -d -v app-volume:/app/src -p 3000:3000 api-rocket:v3
docker exec -it abc123 bash
touch src/file.log    # criou arquivo
exit
docker stop abc123
docker run -d -v app-volume:/app/src -p 3000:3000 api-rocket:v3  # COM -v
docker exec -it def456 bash
