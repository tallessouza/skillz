    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            "token.actions.githubusercontent.com:sub" = "repo:rocketseat/ci-iac:ref:refs/heads/main"
          }
        }
      }
    ]
...
resource "aws_iam_role" "ecr_role" {
  ...
  assume_role_policy = jsonencode({
    ...
    Condition = {
      StringEquals = {
        "token.actions.githubusercontent.com:sub" = "repo:rocketseat/ci-api:ref:refs/heads/main"
      }
    }
  })
}
