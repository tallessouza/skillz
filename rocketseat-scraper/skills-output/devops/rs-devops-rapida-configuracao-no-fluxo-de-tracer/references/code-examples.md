...
```
{service_name="AppRocketCity2"} | trace_id="abc123def456"
```

Onde:
- `${__tags}` → expandido para `service_name="AppRocketCity2"` (baseado na tag configurada)
...
2. **Explorer → Loki**: Selecione o service name (ex: `AppRocketCity2`)
