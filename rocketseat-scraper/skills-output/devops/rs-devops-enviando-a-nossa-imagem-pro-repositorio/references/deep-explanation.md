...
Um ponto critico que causa falhas silenciosas: o Docker Hub organiza repositorios como `username/repo-name`. Quando voce faz `docker build -t rocketseat-ci-api:tag`, o build funciona localmente, mas o push falha porque o Docker Hub nao sabe para qual conta enviar.

A solucao e sempre incluir o username no tag:
```
danielrodrigues/rocketseat-ci-api:abc123
```
