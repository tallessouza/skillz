...
abc123def456   api-rocket   "yarn run start" 2 minutes ago  Up 2 min  0.0.0.0:3000->3000/tcp   random_name
```
...
```bash
docker run -d --name minha-api -p 3000:3000 api-rocket
