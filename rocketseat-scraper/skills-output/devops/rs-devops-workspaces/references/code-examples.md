...
$ terraform workspace select default
$ terraform plan
# Mostra: rocketseat-bucket-iac-default

$ terraform apply -auto-approve
# Cria bucket "rocketseat-bucket-iac-default"

# No workspace staging:
$ terraform workspace select staging
$ terraform plan
# Mostra: mudanca de "rocketseat-bucket-iac" para "rocketseat-bucket-iac-staging"
