...
1. Voce cria o bucket no workspace `staging` com nome `rocketseat-bucket-iac`
...
A solucao e usar `terraform.workspace` como parte do nome: `rocketseat-bucket-iac-${terraform.workspace}`
