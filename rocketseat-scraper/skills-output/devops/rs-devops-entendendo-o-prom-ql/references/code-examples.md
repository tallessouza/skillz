...
http_requests_total{service_name="rocketseat"}
```
...
# Multiplas labels
http_requests_total{service_name="rocketseat", environment="production"}
...
```
# Builder: Metric = http_requests_total, Label = service_name, Value = rocketseat
...
```
# LogQL (Loki)
{service_name="rocketseat"} |= "error"

# TraceQL (Tempo)
{resource.service.name="rocketseat"}
