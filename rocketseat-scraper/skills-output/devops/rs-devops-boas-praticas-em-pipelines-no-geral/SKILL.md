...
3. **Nomes de servico sao variaveis** — `vars.SERVICE_NAME` nao `rocketseat-api` hardcoded, porque mudam entre ambientes mas nao sao sensiveis
...
| `--service-name rocketseat-api` | `--service-name ${{ vars.SERVICE_NAME }}` |
