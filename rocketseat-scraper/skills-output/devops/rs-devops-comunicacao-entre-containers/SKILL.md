...
2. **Nomeie todo container explicitamente** — `container_name: api-rocket` nao deixar o Compose gerar nomes automaticos com prefixo do diretorio, porque nomes automaticos sao confusos em logs e inspecao
