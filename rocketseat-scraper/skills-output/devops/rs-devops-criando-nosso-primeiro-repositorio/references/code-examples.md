...
gh repo create rocketseat.ci.api \
  --private \
...
Campos:
- Repository name: rocketseat.ci.api
- Description: Primeiro projeto para testes de CI e CD
- Visibility: Private
...
git remote add origin git@github.com:seu-usuario/rocketseat.ci.api.git
...
git remote add origin https://github.com/seu-usuario/rocketseat.ci.api.git
...
```bash
# Via CLI
gh repo view rocketseat.ci.api --web

# Ou simplesmente acesse:
# https://github.com/seu-usuario/rocketseat.ci.api
```
