...
Dentro da pasta organizada (ex: "Rocketseat"):
...
Label filter: service_name = "app-rocketseat"
```
...
Usar nos paineis:
```promql
hello_success_total{service_name="app-rocketseat", environment="$environment"}
```
