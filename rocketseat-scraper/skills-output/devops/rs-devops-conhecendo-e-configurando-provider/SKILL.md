...
3. **Use o ID do projeto, nunca o nome** — o ID garante unicidade (`rocketseat-438714`), o nome pode ser duplicado
...
provider "google" {
  project = "Rocketseat"  # nome, nao ID
  region  = "us-central1"
...
provider "google" {
  project = "rocketseat-438714"  # ID unico
  region  = "us-central1"
}
```
...
| `project = "Rocketseat"` (nome) | `project = "rocketseat-438714"` (ID) |
