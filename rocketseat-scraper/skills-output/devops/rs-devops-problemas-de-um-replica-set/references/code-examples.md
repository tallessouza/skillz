...
docker build -t user-rocket:${COMMIT_HASH} .
docker push user-rocket:${COMMIT_HASH}

# No manifesto Kubernetes:
# image: user-rocket:abc123f  ← tag rastreavel ao commit

# NUNCA:
# image: user-rocket:latest   ← imprevisivel, impossivel rastrear
```