...
2. **Separe registry de repository** — o URI do ECR tem duas partes: `123456789.dkr.ecr.region.amazonaws.com` (registry) e `rocket-ci` (repository), porque confundir os dois quebra o push
...
- name: Build and Push
  run: |
    ...
    docker build -t 123456789.dkr.ecr.us-east-2.amazonaws.com/rocket-ci:abc123 .
    docker push 123456789.dkr.ecr.us-east-2.amazonaws.com/rocket-ci:abc123
```
