...
```
123456789.dkr.ecr.us-east-2.amazonaws.com/rocket-ci:tag
...
- **Repository**: e o nome do repositorio dentro do registry (ex: `rocket-ci`). Dentro dele ficam as image tags.
- **Tag**: identificador da versao da imagem.

No DockerHub, a estrutura era `username/image:tag` (ex: `danielrodrigues/rocket-ci:latest`). No ECR, o registry e um URI completo.
...
4. **Legibilidade** — `$REGISTRY/rocket-ci:$TAG` e muito mais legivel que o URI completo
