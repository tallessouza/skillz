...
hello_success_total{service_name="app-rocketseat", service_version="1.0"}

# Ver total de erros
hello_error_total{service_name="app-rocketseat", service_version="1.0"}

# Comparar ambos no mesmo gráfico (adicione como query A e B)
# Query A: hello_success_total{service_name="app-rocketseat"}
# Query B: hello_error_total{service_name="app-rocketseat"}
```
