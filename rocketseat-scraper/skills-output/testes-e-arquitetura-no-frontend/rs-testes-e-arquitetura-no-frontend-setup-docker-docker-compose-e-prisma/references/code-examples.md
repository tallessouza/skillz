...
services:
  postgres:
    ...
    container_name: rocketseat-prompt-managerdb
    ports:
      - "5432:5432"
    environment:
      POSTGRES_USER: postgres
      POSTGRES_PASSWORD: password
      POSTGRES_DB: rocketseat-prompt-manager
    volumes:
...
```env
DATABASE_URL="postgresql://postgres:password@localhost:5432/rocketseat-prompt-manager?schema=public"
```
...
DATABASE_URL="postgresql://postgres:password@localhost:5433/rocketseat-prompt-manager?schema=public"
```