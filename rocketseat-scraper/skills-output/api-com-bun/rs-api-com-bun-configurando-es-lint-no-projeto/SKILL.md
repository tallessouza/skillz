...
# Configurando ESLint com Rocketseat Config + Drizzle Plugin

> Configure ESLint com regras da Rocketseat e protecao contra queries perigosas do Drizzle ORM.
...
```bash
bun add -d eslint @rocketseat/eslint-config eslint-plugin-drizzle
...
| Situacao | Acao |
|----------|------|
| Novo projeto TypeScript com Drizzle | Instalar eslint + rocketseat config + drizzle plugin |
