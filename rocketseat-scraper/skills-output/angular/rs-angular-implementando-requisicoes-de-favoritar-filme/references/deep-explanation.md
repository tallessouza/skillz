...
O padrao da Rocketseat e criar um arquivo por interface de response na pasta `shared/models/`. O nome do arquivo segue o padrao kebab-case que descreve o contrato: `move-to-favorite-success-response.ts`.
