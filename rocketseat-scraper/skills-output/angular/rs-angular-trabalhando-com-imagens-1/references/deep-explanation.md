...
Quando voce escreve `/images/rocketseat.png` no HTML ou CSS, o Angular sabe que esse caminho e relativo ao servidor. Durante o `ng build`, ele copia `public/images/rocketseat.png` para `dist/nome-do-projeto/browser/images/rocketseat.png`. O servidor de producao serve `dist/.../browser/` como raiz, entao `/images/rocketseat.png` resolve corretamente.
