...
4. **ESLint minimalista** — use `@rocketseat/eslint-config` e remova prettier/plugins extras, porque ESLint complexo que reescreve o arquivo inteiro atrapalha mais do que ajuda
...
| Prettier + ESLint plugins separados | `@rocketseat/eslint-config` unico |
