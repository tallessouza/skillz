...
description: "Generates Next.js authentication pages with ShadCN UI following Rocketseat's SaaS RBAC patterns. Use when user asks to 'create login page', 'build sign-in form', 'auth page layout', 'authentication UI', or 'create sign-up page' in Next.js App Router projects. Applies centered auth layout, ShadCN theme variables for colors, SVG icon dark mode inversion, and proper form structure. Make sure to use this skill whenever building authentication interfaces in Next.js with ShadCN. Not for API auth logic, JWT handling, session management, or backend authentication flows."
---
