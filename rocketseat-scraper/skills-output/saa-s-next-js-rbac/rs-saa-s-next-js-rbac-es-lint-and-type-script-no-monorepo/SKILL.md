...
| App Next.js no monorepo | Estenda `@rocketseat/eslint-config/next` |
| API Node.js no monorepo | Estenda `@rocketseat/eslint-config/node` |
| Pacote de lib pura | Estenda `@rocketseat/eslint-config/react` |
