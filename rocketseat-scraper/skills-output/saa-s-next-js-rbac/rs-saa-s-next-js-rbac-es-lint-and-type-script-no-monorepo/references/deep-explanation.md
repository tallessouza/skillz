...
| Config | Estende | Uso |
|--------|---------|-----|
| `next.js` | `@rocketseat/eslint-config/next` | Apps Next.js (frontend) |
| `node.js` | `@rocketseat/eslint-config/node` | APIs Node.js (backend) |
| `library.js` | `@rocketseat/eslint-config/react` | Pacotes de biblioteca React |
