...
1. **Use slug, não ID da organização** — `orgs/rocketseat/projects` não `orgs/clkj2f0x0000.../projects`, porque o slug já é único (índice no banco) e produz URLs legíveis no front-end
