...
Cenario: organizacao "Rocketseat" com dominio "rocketseat.com.br". Usuario abre formulario de edicao, nao muda nada, clica salvar. O formulario envia todos os campos, incluindo o dominio inalterado.

Sem o `id: { not: organization.id }`:
1. Backend recebe `domain: "rocketseat.com.br"`
...
O slug aparece na URL: `app.com/org/rocketseat/projects`. Se o usuario renomear a organizacao de "Rocketseat" para "Rocket Education" e o slug mudar para `rocket-education`, todos os links salvos como favoritos, compartilhados em documentos, ou indexados por ferramentas, quebram.
