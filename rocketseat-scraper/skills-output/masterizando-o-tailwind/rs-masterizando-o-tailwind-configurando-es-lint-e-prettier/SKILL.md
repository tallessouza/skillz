...
A config `@rocketseat/eslint-config/next` ja inclui `plugin:prettier/recommended` e regras do Prettier, porque o ESLint precisa estar integrado com Prettier para que plugins do Prettier funcionem via ESLint.
