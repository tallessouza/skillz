...
description: "Generates initial Next.js project setup with Docker Compose when user asks to 'create a Next.js project', 'setup Next.js', 'start a new Next app', 'initialize Next.js with Docker', or 'scaffold a pet shop app'. Follows Rocketseat conventions: TypeScript, ESLint, Tailwind, App Router, src directory, no Turbopack. Make sure to use this skill whenever setting up a new Next.js project from scratch. Not for adding features to existing Next.js projects, not for Docker-only setups, not for other frameworks."
---
