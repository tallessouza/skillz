...
1. **Descreva a intencao, nao a aparencia** — para logos, escreva `Rocketseat Blog` nao `foguete roxo inclinado 45 graus com chamas`, porque o texto alternativo deve transmitir o que a imagem representa, nao o que ela mostra visualmente
2. **Nunca prefixe com "imagem de" ou "logo de"** — leitores de tela ja informam que o elemento e uma imagem, entao `alt="Rocketseat"` nao `alt="Logo da Rocketseat"`, porque seria informacao redundante
...
<img src="/logo.svg" alt="Rocketseat Blog" />
...
| Situation | Do |
|-----------|-----|
| Logo de empresa/produto | Descreva a marca: `alt="Rocketseat"` |
...
|-------------|---------------|
| `<img src="logo.svg" />` (sem alt) | `<img src="logo.svg" alt="Rocketseat" />` |
| `alt="Imagem da logo da Rocketseat"` | `alt="Rocketseat"` |
| `alt="foguete roxo com chamas"` (logo) | `alt="Rocketseat Blog"` |
