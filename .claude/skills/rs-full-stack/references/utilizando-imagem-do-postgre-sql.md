...
## Deep dive
- [Deep explanation](../../../data/skills/full-stack/rs-full-stack-utilizando-imagem-do-postgre-sql/references/deep-explanation.md)
- [Code examples](../../../data/skills/full-stack/rs-full-stack-utilizando-imagem-do-postgre-sql/references/code-examples.md)
