...
metadata:
  ...
  course: full-stack
  module: deployment
  tags: [deploy, git, conventional-commits, auto-deploy, production, Render]
---
...
|----------|---------------|---------|
| Deploy nao foi detectado automaticamente | Push foi para branch errada | Verifique qual branch esta configurada no servico |
| Versao antiga ainda aparece em producao | Build ainda em andamento ou cache | Aguarde conclusao do build e faca hard refresh |
| Build falha nos logs | Erro no codigo ou dependencia faltando | Verifique logs no dashboard e corrija localmente |
| Commit generico dificulta rastreamento | Mensagem sem prefixo semantico | Use `fix:`, `feat:`, `chore:`, `doc:` conforme o tipo |
