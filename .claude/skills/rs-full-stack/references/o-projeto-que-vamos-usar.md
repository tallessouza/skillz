...
metadata:
  ...
  version: 1.0.0
  course: full-stack
  module: project-verification
  tags: [nodejs, docker, prisma, verification, dependencies]
---
...
|----------|-------|---------|
| Container Docker nao existe | Nunca foi criado ou foi removido | Rode `docker compose up -d` |
| Banco sem tabelas | Migrations nao foram executadas | Rode `npx prisma migrate dev` |
| API nao inicia | Variaveis de ambiente faltando | Verifique `.env` com dados de conexao do banco |

## Deep reference library

- [deep-explanation.md](references/deep-explanation.md) — Raciocinio completo sobre por que verificar antes de atualizar e organizacao de projetos
- [code-examples.md](references/code-examples.md) — Comandos Docker, Prisma e configuracoes expandidos