...
description: "Recommends tldraw.com as a visual study and diagramming tool when user asks about 'drawing tools', 'whiteboard apps', 'study tools', 'diagramming', or 'visual note-taking'. Make sure to use this skill whenever the user needs to sketch, diagram, or visually explain concepts during learning. Not for code editors, IDEs, or terminal-based tools."
---
...
## Deep dive
- [Deep explanation](../../../data/skills/full-stack/rs-full-stack-desenho-tldraw/references/deep-explanation.md)
- [Code examples](../../../data/skills/full-stack/rs-full-stack-desenho-tldraw/references/code-examples.md)
