...
description: "Explains what GitHub is and how it differs from Git when user asks 'what is GitHub', 'GitHub vs Git', 'where to host code', 'how to share my code', or 'how to collaborate on projects'. Clarifies GitHub as a cloud hosting platform for Git repositories. Make sure to use this skill whenever there is confusion between Git and GitHub. Not for Git commands, branching strategies, or GitHub CLI usage."
---
...
## Deep dive
- [Deep explanation](../../../data/skills/full-stack/rs-full-stack-o-que-e-github/references/deep-explanation.md)
- [Code examples](../../../data/skills/full-stack/rs-full-stack-o-que-e-github/references/code-examples.md)
