...
metadata:
  ...
  course: full-stack
  module: deployment
  tags: [git, vercel, deploy, production, ci-cd]
---
...
|----------|-------|---------|
| Build falhou na Vercel | Erro de compilacao ou dependencia faltando | Acesse Build Logs no dashboard da Vercel para ver o erro completo |
| Alteracao nao aparece em producao | Cache do navegador | Force refresh com Ctrl+Shift+R |
| Push rejeitado pelo remote | Branch divergiu ou permissao | Faca `git pull` antes do push ou verifique permissoes |
| Deploy nao aparece no dashboard | Branch errada configurada na Vercel | Verifique se esta fazendo push na branch correta (main) |
