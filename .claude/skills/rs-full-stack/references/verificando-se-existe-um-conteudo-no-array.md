...
## Deep dive
- [Deep explanation](../../../data/skills/full-stack/rs-full-stack-verificando-se-existe-um-conteudo-no-array/references/deep-explanation.md)
- [Code examples](../../../data/skills/full-stack/rs-full-stack-verificando-se-existe-um-conteudo-no-array/references/code-examples.md)
