...
metadata:
  ...
  course: api-com-bun
  module: elysia
  tags: [elysia, route, order, state-machine, cancel, deliver, dispatch, bun]
---
...
### Pedido transiciona para status invalido
**Fix:** Use whitelist de status permitidos, nao blacklist.
