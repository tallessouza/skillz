...
## Deep dive
- [Deep explanation](../../../data/skills/redux-zustand/rs-redux-zustand-ui-dos-modulos-e-player/references/deep-explanation.md)
- [Code examples](../../../data/skills/redux-zustand/rs-redux-zustand-ui-dos-modulos-e-player/references/code-examples.md)
