...
metadata:
  ...
  tags: [next-js, dynamic-routes, app-router, slug, notFound, async-params, server-components]
---
...
- [deep-explanation.md](../../../data/skills/next-js/rs-next-js-criando-a-pagina-de-post/references/deep-explanation.md) — O problema raiz era um conflito de rotas. O projeto tinha duas pastas de roteamento: `app/` e `pages
- [code-examples.md](../../../data/skills/next-js/rs-next-js-criando-a-pagina-de-post/references/code-examples.md) — app/
