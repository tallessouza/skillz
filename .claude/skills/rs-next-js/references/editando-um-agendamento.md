...
metadata:
  ...
  tags: [form, create-edit, children-pattern, react-hook-form, dialog, next-js, reusable-component]
---
...
- [deep-explanation.md](../../../data/skills/next-js/rs-next-js-editando-um-agendamento/references/deep-explanation.md) — O instrutor escolheu passar o botao como `children` em vez de criar uma prop `mode: 'create' | 'edit
- [code-examples.md](../../../data/skills/next-js/rs-next-js-editando-um-agendamento/references/code-examples.md) — // appointment-card.tsx
