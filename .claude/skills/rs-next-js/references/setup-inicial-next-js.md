...
## Deep dive
- [Deep explanation](../../../data/skills/next-js/rs-next-js-setup-inicial-next-js/references/deep-explanation.md)
- [Code examples](../../../data/skills/next-js/rs-next-js-setup-inicial-next-js/references/code-examples.md)
