...
metadata:
  ...
  version: 2.0.0
  course: next-js
  module: period-grouping
  tags: [next-js, typescript, time-periods, grouping, union-types, date-formatting, toLocaleTimeString]
---
...
- [deep-explanation.md](../../../data/skills/next-js/rs-next-js-criando-logica-para-os-periodos/references/deep-explanation.md) — O instrutor demonstra um padrao importante: primeiro ele faz um `map` nos appointments adicionando c
- [code-examples.md](../../../data/skills/next-js/rs-next-js-criando-logica-para-os-periodos/references/code-examples.md) — // src/types/appointment.ts
