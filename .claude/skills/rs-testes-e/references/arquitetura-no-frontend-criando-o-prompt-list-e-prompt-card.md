---
name: rs-testes-arq-prompt-list-card
...
## Deep dive
- [Deep explanation](../../../data/skills/testes-e/rs-testes-e-arquitetura-no-frontend-criando-o-prompt-list-e-prompt-card/references/deep-explanation.md)
- [Code examples](../../../data/skills/testes-e/rs-testes-e-arquitetura-no-frontend-criando-o-prompt-list-e-prompt-card/references/code-examples.md)
