---
name: rs-testes-arq-fe-delete-prompt-action
...
## Deep dive
- [Deep explanation](../../../data/skills/testes-e/rs-testes-e-arquitetura-no-frontend-criando-a-delete-prompt-action/references/deep-explanation.md)
- [Code examples](../../../data/skills/testes-e/rs-testes-e-arquitetura-no-frontend-criando-a-delete-prompt-action/references/code-examples.md)
