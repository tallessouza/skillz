---
name: rs-testes-arq-frontend-testes-prisma-repo
...
## Deep dive
- [Deep explanation](../../../data/skills/testes-e/rs-testes-e-arquitetura-no-frontend-criando-os-testes-do-prisma-prompt-repository/references/deep-explanation.md)
- [Code examples](../../../data/skills/testes-e/rs-testes-e-arquitetura-no-frontend-criando-os-testes-do-prisma-prompt-repository/references/code-examples.md)
