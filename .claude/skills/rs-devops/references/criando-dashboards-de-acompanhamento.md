...
1. **Organize dashboards em folders** — crie folders por aplicacao ou time (ex: `Skillz`), porque sem organizacao os dashboards viram uma lista caótica impossivel de navegar
...
Query: selecionar service_name = "app-skillz-seat-exemplo"
...
- Folder "Skillz" agrupa todos os dashboards do time
