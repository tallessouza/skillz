...
metadata:
  ...
  course: node-js-2023
  module: use-cases
  tags: [fetch, list, pagination, comments, findMany, ddd, clean-architecture]
---
...
- [deep-explanation.md](mdc:data/skills/node-js-2023/rs-node-js-2023-caso-de-uso-listar-comentarios-da-pergunta/references/deep-explanation.md) — Raciocinio completo, analogias e edge cases
- [code-examples.md](mdc:data/skills/node-js-2023/rs-node-js-2023-caso-de-uso-listar-comentarios-da-pergunta/references/code-examples.md) — Todos os exemplos de codigo expandidos com variacoes
