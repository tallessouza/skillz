...
metadata:
  ...
  tags: [ddd, use-case, clean-architecture, repository, value-object, typescript, solid]
---
...
- [deep-explanation.md](mdc:data/skills/node-js-2023/rs-node-js-2023-caso-de-uso-criar-pergunta/references/deep-explanation.md) — Raciocinio completo, analogias e edge cases
- [code-examples.md](mdc:data/skills/node-js-2023/rs-node-js-2023-caso-de-uso-criar-pergunta/references/code-examples.md) — Todos os exemplos de codigo expandidos com variacoes
