...
metadata:
  ...
  course: node-js-2023
  module: testing
  tags: [testing, describe, it, vitest, jest, naming-convention, organization]
---
...
- [deep-explanation.md](mdc:data/skills/node-js-2023/rs-node-js-2023-categorizando-os-testes/references/deep-explanation.md) — Raciocinio completo, analogias e edge cases
- [code-examples.md](mdc:data/skills/node-js-2023/rs-node-js-2023-categorizando-os-testes/references/code-examples.md) — Todos os exemplos de codigo expandidos com variacoes
