...
> Configure ESLint com preset Skillz para padronizar codigo automaticamente no save e via CLI.
...
- Se usar outro preset, substitua `@skillz/eslint-config` pelo seu
...
Para projetos React, use `@skillz/eslint-config/react` em vez de `/node`.
