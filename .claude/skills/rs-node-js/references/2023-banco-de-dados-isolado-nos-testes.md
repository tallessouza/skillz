...
metadata:
  ...
  course: node-js-2023
  module: e2e-testing
  tags: [e2e, testing, prisma, postgresql, database-isolation, vitest, schema]
---
...
- [deep-explanation.md](mdc:data/skills/node-js-2023/rs-node-js-2023-banco-de-dados-isolado-nos-testes/references/deep-explanation.md) — Raciocinio completo, analogias e edge cases
- [code-examples.md](mdc:data/skills/node-js-2023/rs-node-js-2023-banco-de-dados-isolado-nos-testes/references/code-examples.md) — Todos os exemplos de codigo expandidos com variacoes
