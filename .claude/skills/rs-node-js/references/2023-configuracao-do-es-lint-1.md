...
description: "Applies Skillz ESLint configuration when setting up linting in Node.js or TypeScript projects. Use when user asks to 'configure eslint', 'setup linting', 'add code style', 'configure skillz eslint', or 'padronizar codigo'. Generates .eslintrc.json, lint scripts, and handles Vitest globals plugin. Make sure to use this skill whenever setting up ESLint in a Node/TS project. Not for React-specific ESLint setup, Prettier configuration, or runtime code patterns."
---

# Configuracao do ESLint com Skillz Config

> Configurar ESLint com a config da Skillz, scripts de lint, e resolver problemas comuns como Vitest globals e no-useless-constructor.
...
| Situacao | Acao |
|----------|------|
| Projeto Node.js/API | `@skillz/eslint-config/node` |
| Projeto React/Next | `@skillz/eslint-config/react` |
...
## Deep dive
- [Deep explanation](../../../data/skills/node-js/rs-node-js-2023-configuracao-do-es-lint-1/references/deep-explanation.md)
- [Code examples](../../../data/skills/node-js/rs-node-js-2023-configuracao-do-es-lint-1/references/code-examples.md)
