...
## Deep dive
- [Deep explanation](../../../data/skills/saa-s/rs-saa-s-next-js-rbac-fluxo-de-o-auth-com-git-hub/references/deep-explanation.md)
- [Code examples](../../../data/skills/saa-s/rs-saa-s-next-js-rbac-fluxo-de-o-auth-com-git-hub/references/code-examples.md)
