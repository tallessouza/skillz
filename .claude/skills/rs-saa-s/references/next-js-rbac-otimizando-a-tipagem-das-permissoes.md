...
## Deep dive
- [Deep explanation](../../../data/skills/saa-s/rs-saa-s-next-js-rbac-otimizando-a-tipagem-das-permissoes/references/deep-explanation.md)
- [Code examples](../../../data/skills/saa-s/rs-saa-s-next-js-rbac-otimizando-a-tipagem-das-permissoes/references/code-examples.md)
