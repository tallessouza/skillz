...
## Deep dive
- [Deep explanation](../../../data/skills/saa-s/rs-saa-s-next-js-rbac-lidando-com-convite-p-outro-e-mail/references/deep-explanation.md)
- [Code examples](../../../data/skills/saa-s/rs-saa-s-next-js-rbac-lidando-com-convite-p-outro-e-mail/references/code-examples.md)
