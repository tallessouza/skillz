...
skill_awareness:
  description: "Consulte skill routers para validação de stories"
  primary:
    - path: .claude/skills/rs-implementation-workflow/SKILL.md
      when: "Validar se story cobre todas as fases de implementação"
  secondary:
    - path: .claude/skills/rs-quality/SKILL.md
      when: "Definir acceptance criteria de qualidade"
  rule: "Na validação de stories, verifique se os acceptance criteria cobrem os padrões definidos em skills relevantes."
