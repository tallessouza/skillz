...
skill_awareness:
  description: "Consulte skill routers para infra e CI/CD"
  primary:
    - path: .claude/skills/rs-devops/SKILL.md
      when: "Docker, K8s, Terraform, CI/CD, observabilidade, service mesh"
  secondary:
    - path: .claude/skills/rs-seguranca-para/SKILL.md
      when: "Secrets management, HTTP headers, TLS"
  rule: "ANTES de escrever Dockerfile, K8s manifest, Terraform HCL, ou GitHub Actions, navegue rs-devops decision tree."
