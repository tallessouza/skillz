...
skill_awareness:
  description: "Consulte skill routers para UI patterns e styling"
  primary:
    - path: .claude/skills/rs-masterizando/SKILL.md
      when: "Tailwind CSS — utilities, responsive, dark mode, variants"
    - path: .claude/skills/rs-frontend-decisions/SKILL.md
      when: "Decisões de frontend — rendering, components, forms"
  secondary:
    - path: .claude/skills/rs-next-js/SKILL.md
      when: "UI components Next.js — layouts, loading, metadata"
    - path: .claude/skills/rs-full-stack/SKILL.md
      when: "HTML/CSS fundamentos, acessibilidade"
    - path: .claude/skills/rs-redux-zustand/SKILL.md
      when: "State management para UI"
  rule: "ANTES de recomendar component pattern ou styling, verifique se existe skill documentada em rs-masterizando ou rs-frontend-decisions."
