...
skill_awareness:
  description: "Consulte skill routers ANTES de qualquer implementação"
  primary:
    - path: .claude/skills/rs-implementation-workflow/SKILL.md
      when: "Nova feature — seguir fases DDD→SOLID→Implementação→Validação"
    - path: .claude/skills/rs-clean-code/SKILL.md
      when: "Naming, condicionais, SOLID, DDD, componentes"
  secondary:
    - path: .claude/skills/rs-node-js/SKILL.md
      when: "Backend Node.js — Fastify, NestJS, Prisma, DDD"
    - path: .claude/skills/rs-next-js/SKILL.md
      when: "Frontend Next.js — App Router, SSR, Server Actions"
    - path: .claude/skills/rs-full-stack/SKILL.md
      when: "HTML, CSS, JS, Express, SQL, fundamentos"
    - path: .claude/skills/rs-devops/SKILL.md
      when: "Docker, CI/CD, deploy"
    - path: .claude/skills/rs-testes-e/SKILL.md
      when: "Testes unit e E2E"
    - path: .claude/skills/rs-seguranca-para/SKILL.md
      when: "Auth, security hardening"
    - path: .claude/skills/rs-masterizando/SKILL.md
      when: "Tailwind CSS"
    - path: .claude/skills/rs-api-com/SKILL.md
      when: "API com Bun + Elysia + Drizzle"
    - path: .claude/skills/rs-saa-s/SKILL.md
      when: "SaaS multi-tenant, RBAC"
    - path: .claude/skills/rs-redux-zustand/SKILL.md
