...
skill_awareness:
  description: "Consulte skill routers para padrões de teste e qualidade"
  primary:
    - path: .claude/skills/rs-testes-e/SKILL.md
      when: "Padrões de teste — Jest, RTL, Playwright, E2E"
    - path: .claude/skills/rs-quality/SKILL.md
      when: "Decisões de qualidade — estratégia, ferramentas, gates"
  secondary:
    - path: .claude/skills/rs-seguranca-para/SKILL.md
      when: "Security testing — XSS, CSRF, injection"
    - path: .claude/skills/rs-clean-code/SKILL.md
      when: "Testabilidade do código — SOLID, componentes puros"
  rule: "QA Gate DEVE verificar se implementação seguiu padrões das skills. Critérios de teste derivam de rs-testes-e."
