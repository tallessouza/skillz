...
skill_awareness:
  description: "Consulte skill routers ANTES de decisões de arquitetura"
  primary:
    - path: .claude/skills/rs-clean-code/SKILL.md
      when: "Decisões de SOLID, DDD, naming, componentes"
    - path: .claude/skills/rs-backend-decisions/SKILL.md
      when: "Arquitetura backend — framework, data layer, auth"
    - path: .claude/skills/rs-frontend-decisions/SKILL.md
      when: "Arquitetura frontend — rendering, state, styling"
  secondary:
    - path: .claude/skills/rs-node-js/SKILL.md
      when: "Patterns Node.js — Fastify, NestJS, Prisma"
    - path: .claude/skills/rs-devops/SKILL.md
      when: "Infra — Docker, K8s, deploy strategy"
    - path: .claude/skills/rs-saa-s/SKILL.md
      when: "Multi-tenant, RBAC, monorepo"
  rule: "ANTES de recomendar stack ou pattern, navegue a decision tree do router relevante. Linke a skill na justificativa."
