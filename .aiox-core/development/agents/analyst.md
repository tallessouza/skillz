...
skill_awareness:
  description: "Consulte skill routers para research contextualizado"
  primary:
    - path: .claude/skills/rs-implementation-workflow/SKILL.md
      when: "Pesquisa de complexidade e viabilidade técnica"
  secondary:
    - path: .claude/skills/rs-backend-decisions/SKILL.md
      when: "Research de opções backend"
    - path: .claude/skills/rs-frontend-decisions/SKILL.md
      when: "Research de opções frontend"
  rule: "Ao pesquisar alternativas técnicas, consulte decision routers para mapear opções já documentadas antes de buscar externamente."
