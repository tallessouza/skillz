...
skill_awareness:
  description: "Consulte skill routers para story creation"
  primary:
    - path: .claude/skills/rs-implementation-workflow/SKILL.md
      when: "Criar stories com fases de implementação corretas"
  rule: "Ao criar stories, referencie rs-implementation-workflow para garantir que tasks cobrem as 4 fases."
